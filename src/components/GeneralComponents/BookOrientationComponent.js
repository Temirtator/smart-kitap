...
class BookOrientation extends Component {
    ...
    bookOrientationFlashing() {
        ...
        if (isInMainPage) {
            if(selected) {
                let menuName = selected.slice(5, selected.length)
                this.checkChosen(menuName)                                
            }
        }
    }
    componentDidMount() {
        ...
        return (
            <div ref="bookOrientation" className="book-orientation-component">
                <Link to="/main-personal-page">
                    <div    onClick={goBack} 
                            className="content__body__main__header__back">
                        <div style={iconStyle}>
                ...
                <div className="content__body__main__header__menu">
                    <div    onClick={() => this.clickOnMenu('conspect')} 
                            className={chosen[0] ? 'header__menu__conspect header__menu--selected' : 'header__menu__conspect'}>
                        <svg    version="1.1" 
                                id="Capa_1" 
                    ...
                    <div    onClick={() => this.clickOnMenu('video')} 
                            className={chosen[1] ? 'header__menu__video header__menu--selected' : 'header__menu__video'}>
                            <svg    version="1.1" 
                                    id="Layer_1" 
                                    xmlns="http://www.w3.org/2000/svg" 
                                    xmlnsXlink="http://www.w3.org/1999/xlink" 
                    ...
                    <div    onClick={() => this.clickOnMenu('test')} 
                            className={chosen[2] ? 'header__menu__test header__menu--selected' : 'header__menu__test'}>
                            <svg    version="1.1" 
                                    id="Layer_1" 
                                    xmlns="http://www.w3.org/2000/svg" 
                                    xmlnsXlink="http://www.w3.org/1999/xlink" 
